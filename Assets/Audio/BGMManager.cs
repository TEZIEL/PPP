...
public class BGMManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        AudioSourceRuntimeDumper.DumpAllPlayingAudioSources("BGMManager.Awake after EnsureSavedAudioSettingsApplied");
        AudioSourceRuntimeDumper.DumpAudioSourcesNextFrame(this, "BGMManager.Awake nextFrame");
