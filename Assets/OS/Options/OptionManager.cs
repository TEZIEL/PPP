...
public class OptionManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        ApplyAllVolumeSettings();
        AudioSourceRuntimeDumper.DumpAudioSourcesNextFrame(this, "OptionManager.Start nextFrame");
    }
    ...
    public void OnOpen()
    {
        ...
        AudioSourceRuntimeDumper.DumpAllPlayingAudioSources("OptionManager.OnOpen before");
        preview = applied.Clone();
        ...
        AudioSourceRuntimeDumper.DumpAllPlayingAudioSources("OptionManager.OnOpen after");
        AudioSourceRuntimeDumper.DumpAudioSourcesNextFrame(this, "OptionManager.OnOpen nextFrame");
    }
